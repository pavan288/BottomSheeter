...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of BottomSheeter.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/pavan.powani@practo.com/BottomSheeter'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'pavan.powani@practo.com' => 'pavan.powani@practo.com' }
  s.source           = { :git => 'https://github.com/pavan.powani@practo.com/BottomSheeter.git', :tag => s.version.to_s }
